...
df_vt <- read.csv("data/vermont_voterlist.csv")
df_vt_collapsed <- read.csv("data/task1_vermont_voterlist_collapsed.csv")
df_census <- read.csv("data/census.csv")
df_tx <- read.csv("data/TXturnout.csv")
df_wi <- read.csv("data/wi.csv")
################################################################################
## Minor adjustments to clean up
df_b <- df_b %>% 
...
################################################################################
# Adjust df_f
# * Fix incorrect numbers for a small subset
df_f <- df_f %>%
...
# How many counties are there that have still data problems
